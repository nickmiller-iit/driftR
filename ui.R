shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      br(),br(),
      textInput("p","Starting allele frequency A",value="0.1"),
      sliderInput("Uab","Mutation Rate",value=0,min=0,max=0.1),
      sliderInput("Waa","Fitness of genotype AA",value=1,min=0,max=1),
      sliderInput("Wab","Fitness of genotype AB",value=0.8,min=0,max=1),
      sliderInput("Wbb","Fitness of genotype BB",value=0.8,min=0,max=1),
